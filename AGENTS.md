...
reviews, ACP chat, and PTY sessions. Rust emits eleven events — `session_output`,
`session_activity`, `session_idle`, `session_needs_input`, `session_exited`,
`review_loop_updated`, `review_output`, `session_chat`, `pr_review_output`, `pr_review_updated`,
