...
reviews, and ACP chat. Rust emits nine events — `review_loop_updated`,
`review_output`, `session_chat`, `session_chat_usage`, `session_chat_runtime`,
